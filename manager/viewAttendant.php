	...
	<body>
		<header>
			<div class="header_div">
				...
				<a href="javascript:void(0)" class="closebtn" onclick="closeNav()">x</a>
					...
					<a href="viewTeller.php">View Teller</a><br>
		...
		<div class="body_content">
			<?php
				...
				$result = $mysqli -> query("SELECT * FROM attendant") or die($mysqli->error);
			?>
			<?php
				...
				?>
                   <div class="ino_card">
						<h3>Attendant <?php echo $row['AttendantID']; ?></h3><hr>
						<span class="data_label">ID/Passport: </span><span class="data_label2"><?php echo $row['AttendantIDNo']; ?></span><br><br>
						<span class="data_label">First Name: </span><span class="data_label2"><?php echo $row['AttendantFname']; ?></span><br><br>
						<span class="data_label">Other Names: </span><br><span class="data_label2"><?php echo $row['AttendantLname']; ?></span><br><br>
